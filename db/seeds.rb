...
listing = car.listings.create!(profile_id:1, car_id:1, price:40000, description:'My Toyota 86. All modifications listed in the modification section.', color:'red', year:2015)
